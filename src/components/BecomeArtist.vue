        ...
        <div class="grid m-5">
            <div class="col-6">
                <div class="flex flex-column gap-2">
                    ...
                    <InputText id="name" v-model="artistObject.name" :class="classObject.nameClass"
                        @input="() => { classObject.nameClass = ''; errorObject.message = '' }" />
            ...
            <div class="col-6">
                <div class="flex flex-column gap-2">
                    ...
                    <InputNumber v-model="artistObject.price" inputId="currency-us" mode="currency" currency="USD"
                        :class="classObject.priceClass" locale="en-US"
                        @input="() => { classObject.priceClass = ''; errorObject.message = '' }" />
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="flex flex-column gap-2">
                    ...
                    <Textarea v-model="artistObject.description" rows="5" cols="30"
                        :class="classObject.descriptionClass"
                        @input="() => { classObject.descriptionClass = ''; errorObject.message = '' }" />
            ...
            <div class="col-6">
                <div class="flex flex-column gap-2">
                    ...
                    <MultiSelect v-model="artistObject.genre" :options="genres" option-label="GenreName"
            ...
            <div class="col-6">
                <div class="flex flex-column gap-2">
                    ...
                    <Dropdown v-model="artistObject.type" :options="types" :class="classObject.typeClass"
                        optionLabel="TypeDescription" optionValue="TypeId" placeholder="Select a type"
                        @change="() => { classObject.typeClass = ''; errorObject.message = '' }" />
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="flex flex-column gap-2">
                    ...
                    <Textarea v-model="artistObject.location" rows="5" cols="30" :class="classObject.locationClass"
                        @input="() => { classObject.locationClass = ''; errorObject.message = '' }" />
            ...
            <div class="col-12">
                ...
                <div class="flex flex-column gap-2">
                    <div>
                        <FileUpload name="images" accept="image/*,video/mp4" ref="fileUploadRef"
                            :maxFileSize="100000000" :multiple=false :showUploadButton="false" />
